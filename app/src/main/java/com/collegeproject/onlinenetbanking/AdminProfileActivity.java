...
public class AdminProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnLogout).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
                Toast.makeText(AdminProfileActivity.this, "Logout successfully..", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        mBtnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(FullName)){
                    ...
                    firebaseFirestore.collection("Admin").document(UserId)
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(AdminProfileActivity.this, "Personal details updated", Toast.LENGTH_SHORT).show();
                            }
                        }
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressBar.setVisibility(View.GONE);
                            mBtnUpdate.setVisibility(View.VISIBLE);
                            Toast.makeText(AdminProfileActivity.this, "Error : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
    ...
    private void AddImg() {
        ...
        progressDialog.show();
        StorageReference profileImgPath = storageReference.child("AdminProfile").child(System.currentTimeMillis() + ".jpg");
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                profileImgPath.getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        firebaseFirestore.collection("Admin").document(UserId).update(map)
